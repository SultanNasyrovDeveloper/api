...
from minager.surorm.mixins import Commentable, IfNotExists, Overridable
from minager.surorm.types import Expression, Renderable, TableType
...
class DefineField(Overridable, IfNotExists, Commentable, Renderable):
    ...
    def type(self, type_: Expression, is_optional: bool = False, is_flexible: bool = False) -> Self:
        self._type = type_
